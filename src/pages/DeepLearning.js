...
const DeepLearning = () => {
    return (
        <div>
            <Header/>
            <div class="insighthed powerbibanner">
<div class="container">
...
<div class="col-md-4 d-flex align-items-center ">
  ...
  <div>
  <h4 class="wow fadeInUp animated">Insights</h4>
  <h3 class="wow fadeInUp animated">Deep Learning
  </h3>
  <p class="wow fadeInDown animated">Deep Learning is a subset of Machine Learning, which on the
    other hand is a subset of Artificial Intelligence</p>
</div>
</div>
<div class="col-md-8 text-right">

  <img src="images/insighvideo.jpg" class="wow fadeInUp animated"/>
...
<div class="col-md-6 d-flex align-items-center">
  <div>
  <h2 class="titleone wow fadeInUp animated">What is Deep Learning? 
  </h2>
...
<div class="col-md-6 text-right">
  <img src="images/depplearnimg.jpg" class="wow fadeInUp animated"/>
  ...
  <div class="benfitscol">

    <div class="container">
  <h2 class="titleone wow fadeInUp animated">The benefits of Deep Learning</h2>
...
<a href="#" class="benfitlink"><img src="images/relatedarrow-b.png" class="wow fadeInUp animated"/></a>
...
<div class="ourofferings">
  ...
  <div class="container">
<h2 class="titleone wow fadeInUp animated">Ethics of Deep Learning</h2>
...
<div class="row pad_t80">
  ...
  <p class="min-h100">The transfer learning approach is being used by most
  ...
  <div class="col-md-4">
    ...
    <p class="min-h100">In order to train a deep learning network from scratch,
    ...
    <div class="col-md-4">
      ...
      <p class="min-h100">It’s a more specialized, slightly less common approach to
